...
#plot it
ggbiplot::ggbiplot(pca2DData, groups = dataWithNoise$`True Cluster`) + theme_bw()
...
#plot data
ggbiplot::ggbiplot(pca3DData, groups = dataWithNoise$`True Cluster`) + theme_bw()
...
ggbiplot::ggbiplot(pca4DData, groups = dataWithNoise$`True Cluster`, varname.adjust = 0.2) + theme_bw()
